...
public class MenuGetirController extends ArrayAdapter<Urunler> {

    public MenuGetirController(@NonNull Context context, @LayoutRes int resource, @NonNull List<Urunler> items) {
